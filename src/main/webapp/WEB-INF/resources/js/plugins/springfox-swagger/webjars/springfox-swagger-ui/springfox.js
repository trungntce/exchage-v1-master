$(function() {
  var springfox = {
    ...
    "securityConfig": function(cb) {
      $.getJSON(this.baseUrl() + "/resources/js/plugins/springfox-swagger/configuration/security", function(data) {
        cb(data);
      });
    },
    "uiConfig": function(cb) {
      $.getJSON(this.baseUrl() + "/resources/js/plugins/springfox-swagger/configuration/ui", function(data) {
        cb(data);
      });
    }
  };
  window.springfox = springfox;
  window.oAuthRedirectUrl = springfox.baseUrl() + '/resources/js/plugins/springfox-swagger/webjars/springfox-swagger-ui/o2c.html';
