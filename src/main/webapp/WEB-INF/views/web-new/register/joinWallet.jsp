      ...
      <!-- body -->
        ...
        <article class="join-wrap">
          <div class="article-inner">
            ...
            <!-- FORM -->
            <form id="joinWalletForm" method="POST" action="">
              <div class="join__cont">
                <dl>
                  <dt><spring:message code="register.wallet.information"/></dt>
                  <dd>    
                      <!-- NAME -->
                      ...
                      <div class="mb-4 form-group">
                        ...
                        <input type="password" id="password" name="password" maxlength="32" class="form-control" placeholder="<spring:message code='register.input.password.hint'/>">
                        <span class="form-message form-text text-red"></span>
                      </div>
                      <!-- #PASSWORD -->
                      ...
                      <div class="mb-4 form-group">
                        ...
                        <input type="text" id="bankAccount" name="bankAccount" maxlength="32" class="form-control" placeholder="<spring:message code='register.input.bank.name.hint'/>">
                        <span class="form-message form-text text-red"></span>
                      </div>
                     <!-- #BANK ACCOUNT -->
                      ...
                      <div class="mb-4 form-group">
                        ...
                        <input type="text" id="tel" name="tel" maxlength="32" class="form-control" placeholder="<spring:message code='register.input.phone.hint'/>">
                        <span class="form-message form-text text-red"></span>
                      </div>
                      <!-- #PHONE -->
                       ...
                       <!-- PHONE -->
                      <div class="mb-4 form-group">
                        <label class="form-label required-label"><spring:message code="register.input.mail"/></label>
                        <input type="text" id="mail" name="mail" maxlength="32" class="form-control" placeholder="<spring:message code='register.input.mail.hint'/>">
                        <span class="form-message form-text text-red"></span>
                      </div>
                      <!-- #PHONE -->
                  </dd>
                ...
                <dl>
                  ...
                  <dd>
                    <div class="mt-4 mb-3 form-check">
                      ...
                      <label class="form-check-label" for="exampleCheck3"><b><strong class="text-primary"><spring:message code="register.using.personal.info.agreement.important.title"/></strong></b>
                      </label>
                    </div>
                    <div class="term-content">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        Validator({
            ...
            rules: [
                ...
                Validator.isRequired('#password', "<spring:message code='the.input.not.valid'/>"),
                ...
                Validator.isEmail('#mail', "<spring:message code='the.input.not.valid'/>"),
                ...
                Validator.maxLength('#password', 32, "<spring:message code='login.maximum.length'/>"),
                ...
                Validator.isConfirmed( '#passwordConfirm', function () {
                    return document.querySelector('#joinWalletForm #password').value;
                  },
