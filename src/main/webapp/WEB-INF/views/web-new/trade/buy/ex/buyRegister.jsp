        ...
        <section class="wrap trade-wrap">
           ...
           <!--  <article class="sub-title sub-title--trade">
            ...
            <div class="container">
                ...
                <br>
                <form id="formbuyRequest" method="post" action="${baseUrl}/buyRequest">
                <div class="trade-pop-form">
                 <!--    <div class="form-full" id="balance-trade">
                    ...
                    <div class="form-full">
                        <spring:message code="common.message.balances.title"/>: <label class="my-balance" wallet-address="${wallet.walletAddress}"></label> ${tokenSymbol}
                        <input type="hidden" class="m-test"/>
                    </div>
                    <div class="form-wrap form-full">
                        <select name="buyerWalletAddress" class="walletSelect" target="#buyRequest">
                    ...
                    <div class="trade-pop-form-info">
                        ...
                        <dl class="trade-pop-form-info-item ex-height-auto">
                            ...
                            <dd>
                                ...
                                <span>(<spring:message code="common.unit.fees.title"/> +<label class="lb-amount-fee">0 </label> <spring:message code="common.unit.won.title"/>)</span>
                            </dd>
                        </dl>
                        <dl class="trade-pop-form-info-item ex-height-auto">
                ...
                <input type="hidden" name="clientId" value="${buyRequest.clientId}" />
                </form>
            </div>
        <!-- * Buy detail infor -->
        </div>
...
<script>
 ...
 // console.log('${tokenSymbol}');
    ...
    $(".walletSelect").change(async function(){
        ...
        loadBalanceWeb({walletAddress: valWallet, symbol: $(".symbol").find("option:selected").val()});
    ...
    $(".tokenNum").keyup(function(){
        ...
        var amount = val * dataset.unitPrice *1;
        var totalPrice = amountFee*1 + amount*1;
