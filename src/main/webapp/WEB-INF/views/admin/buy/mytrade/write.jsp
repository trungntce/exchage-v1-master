                ...
                <table class="w-100">
                    ...
                    <tr>
                        ...
                        <td class="dev-form-content form-group">
                            <select id="symbol" name="symbol" class="dev-form-input">
                            ...
                            <input type="hidden" id="sellerWalletAddress" name="sellerWalletAddress">
                        </td>
                    </tr>
                    ...
                    <tr class="tr-rd tr-site d-none">
                        ...
                        <td class="dev-form-content form-group">
                            <select id="siteDomain" class="form-select dev-form-input">
                    ...
                    <tr>
                        ...
                        <td class="dev-form-content form-group">
                            ...
                            <input type="number" id="quantity" name="quantity" class="dev-form-input onlynum" placeholder="${tokenNumHint}" maxlength="100" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="dev-form-title"><label><spring:message code="history.table.total.price.title"/></label></td>
...
<script>
    ...
    $("[name='symbol']").change(function(){
        ...
        $("#sellerWalletAddress").val(optionSelected.data("walletAddress"));
    ...
    $(".rd-type").change(function(){
        ...
        if(target == ".tr-banker"){
            $("#sellerWalletAddress").val("0x8014cee0f6f494429f2e76b3add33d2842b6126a")
        }else{
            $("#sellerWalletAddress").val("")
        }
    })
