                    ...
                    <div class="table-responsive mb-3">
                        <table class="table table-bordered table-hover text-nowrap align-middle mb-0 table-sm">
                            ...
                            <tr>
                                ...
                                <th colspan="9"><spring:message code="buy.table.trade.info.title"/></th>
                                            ...
                                            <td>
                                                ...
                                                <c:if test="${wallet.role eq 'CLIENT'}">
                                                    <c:if test="${item.state == 1}">
                                                        <form method="POST" action="/admin/buy/request/client/apply">
                                                            <input type="hidden" name="buyId" value="${item.buyId}">
                                                            <button><spring:message code="common.button.apply.title"/></button>
                                                        </form>
                                                    </c:if>
                                                    <c:if test="${item.state == 2 && item.tradeState == 3 && empty item.refBuyId}">
                                                        <form method="POST" action="/admin/buy/request/client/request">
                                                            <input type="hidden" name="buyId" value="${item.buyId}">
                                                            <button><spring:message code="common.button.request.title"/></button>
                                                        </form>
                                                    </c:if>
                                                    <c:if test="${item.state == 2 && item.tradeState == 3 && item.refBuyState == 3}">
                                                        <form method="POST" action="/admin/buy/request/client/finish">
                                                            <input type="hidden" name="buyId" value="${item.buyId}">
                                                ...
                                                <c:if test="${wallet.role eq 'OPERATOR'}">
                                                    <c:if test="${item.state == 2 && item.tradeState == 2 }">
                                                        <form method="POST" action="/admin/buy/request/op/apply">
                                                            <input type="hidden" name="buyId" value="${item.buyId}">
                                                            <button><spring:message code="common.button.apply.title"/></button>
                                                        </form>
                                                    </c:if>
