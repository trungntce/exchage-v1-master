        ...
        <div id="main" class="panel panel-inverse">
            ...
            <div class="panel-heading panel-top">
                <h4 class="panel-title">
                    <spring:message code="admin.subtitle.token.setup.detail.title"/>
                </h4>
                <!-- RIBBON -->
            ...
            <table style="width: 100%">
                <tr>
                    <td colspan="2"><div class="mt-1"><b>Token</b></div></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="dev-form-title"><label><spring:message code="token.table.operator.title"/></label></td>
                    <td class="dev-form-content form-group ps-1">${token.operator}</td>
                </tr>

                <tr>
                    <td class="dev-form-title"><label><spring:message code="token.table.wallet.address.title"/></label></td>
                    <td class="dev-form-content form-group ps-1">${token.walletAddress}</td>
                </tr>

                <tr>
                    <td class="dev-form-title"><label><spring:message code="token.table.name.title"/></label></td>
                    <td class="dev-form-content form-group ps-1">${token.name}</td>
                </tr>
                <tr>
                    <td class="dev-form-title"><label><spring:message code="token.table.unit.price.title"/></label></td>
                    <td class="dev-form-content form-group ps-1">${token.unitPrice}</td>
                </tr>

                <!-- Use YN -->
                <tr>
                    <td class="dev-form-title" for="useYn"><label><spring:message code="client.field.useYn.title"/></label></td>
                    <td class="dev-form-content form-group ps-1">${token.useYn}</td>
                </tr>
                <!-- * Use YN -->
