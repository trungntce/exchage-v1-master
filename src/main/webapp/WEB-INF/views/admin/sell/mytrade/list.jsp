  ...
  <div id="content" class="app-content app-wrapper">
    ...
    <div id="main" class="panel panel-inverse">
      ...
      <div class="panel-body">
        ...
        <div class="text-end">
          <a class="btn btn-primary btn-sm me-1" href="${_ctx}/admin/sell/mytrade/write"><spring:message code="button.sell.add.title"/></a>
        </div>
          ...
          <div class="table-responsive mb-3">
            <table class="table table-bordered table-hover text-nowrap align-middle mb-0 table-sm">
              ...
              <c:choose>
                <c:when test="${sellDTOList.size() > 0}">
                  <c:forEach items="${sellDTOList}" var="item" varStatus="loop">
                    <tr class="table-success">
                      ...
                      <td>
                          <c:if test="${item.buyerWalletAddress eq wallet.walletAddress && item.state == 2}">
                              <form method="POST" action="/admin/sell/mytrade/finish">
                ...
                <c:otherwise>
                  <tr><td colspan="19"><spring:message code="common.message.noData.title"/></td></tr>
                </c:otherwise>
              </c:choose>
              </tbody>
            </table>
