...
<!-- header -->
  <%@ include file="/WEB-INF/layout/web/header.jsp"%>
    ...
    <div class="container">
        <form:form modelAttribute="buyRequest" method="post" action="${baseUrl}/buyRequest">
        <div class="trade-pop-form">
            <div class="form-full">
                <spring:message code="common.message.balances.title"/>: <label class="my-balance" wallet-address="${wallet.walletAddress}"></label> BANI
                <input type="hidden" class="m-test"/>
            </div>
            <div class="form-wrap form-full">
                <form:select path="buyerWalletAddress" cssClass="walletSelect" target="#buyRequest">
            ...
            <c:if test="${wallet != null && fn:containsIgnoreCase('TRADER', roleCode)}">
                <div class="form-wrap form-full">
                    <form:select path="type">
                        <form:option value="USER"><spring:message code="buy.register.form.orderKind.user.title"/></form:option>
                        <form:option value="TRADER"><spring:message code="buy.register.form.orderKind.op.title"/></form:option>
                    </form:select>
                </div>
            </c:if>
            ...
            <div class="form-wrap form-full">
                ...
                <form:input path="quantity"  placeholder="${tokenNumHint}" cssClass="tokenNum onlynum" type="text" maxlength="32" target="#buyRequest"/>
            </div>
            ...
            <div class="trade-pop-form-info">
                ...
                <dl class="trade-pop-form-info-item">
                    <dt><spring:message code="buy.register.form.fee.title"/></dt>
                    <dd><label class="lb-fee">0</label><spring:message code="common.unit.count.title"/></dd>
                    <dd></dd>
                </dl>
                <dl class="trade-pop-form-info-item">
                    <dt><spring:message code="buy.register.form.tokenCnt.title"/></dt>
                    <dd><label class="lb-token-cnt">0</label><spring:message code="common.unit.count.title"/></dd>
                    <dd></dd>
                </dl>
                <dl class="trade-pop-form-info-item">
                    <dt><spring:message code="buy.register.form.amount.title"/></dt>
                    <dd><label class="lb-amount"></label>원 <span>(수수료 +<label class="lb-amount-fee">0</label>원)</span></dd>
                    <dd></dd>
                </dl>
                <dl class="trade-pop-form-info-item">
                    <dt><spring:message code="buy.register.form.totalPrice.title"/></dt>
                ...
                <dd class="trade-pop-form-info-item">
                    <dd><font color="red"><spring:message code="buy.register.form.content.title"/></font></dd>
                </dd>
            </div>
            ...
            <div class="start-login">
                ...
                <div class="btn secondary" redirect="${baseUrl}/trade"><spring:message code="common.button.goList.title"/></div>
            </div>
...
<!-- * footer -->
<script>
 console.log($(".walletSelect").find("option:selected").attr("fee") );
    var dataset = {
