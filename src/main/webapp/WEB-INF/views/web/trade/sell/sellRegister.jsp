            ...
            <c:if test="${wallet != null && fn:containsIgnoreCase('TRADER', roleCode)}">
                <div class="form-wrap form-full">
                    <form:select path="type">
                        <form:option value="SITE"><spring:message code="sell.register.form.orderKind.user.title"/></form:option>
                        <form:option value="TRADER"><spring:message code="sell.register.form.orderKind.op.title"/></form:option>
                    </form:select>
                </div>
            </c:if>
