...
public class PageTag extends TagSupport {
	...
	private String paging(int totalCnt, int rowRange, int pageRange, int curPage, String script) {
		...
		sb.append("<ul id=\"paging\" class=\"pagination\">\n");
...
//		}
		...
		if( curPage > 1 ) {
			sb.append("<div class=\"numPN paginate_button page-item \">");
			sb.append("<a href=\"javascript:"+script+"('1');\" class=\"page-link\">&#60;&#60;</a></div>");
			sb.append("<div class=\"numPN over left paginate_button page-item \">");
			sb.append("<a href=\"javascript:"+script+"('").append(curPage-1).append("');\" class=\"page-link\">&#60;</a></div>");
		}
		...
		if( curPage >= 1 && totalCnt > 1 && curPage != pageCnt ) {
			...
			sb.append("<a href=\"javascript:"+script+"('").append(curPage+1).append("');\" class=\"page-link\">&#62;</a></div>");
			sb.append("<div class=\"numPN paginate_button page-item \">");
			sb.append("<a href=\"javascript:"+script+"('").append(totalPage).append("');\" class=\"page-link\">&#62;&#62;</a></div>");
		}
